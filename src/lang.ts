...
type TranslationStructure = {
    ...
    dm_actions: {
        ...
        localNamePrompt: string,
        localPassphrasePrompt: string,
        encounterName: string,
        saveEncounter: string,
        loadEncounter: string,
        deleteEncounter: string,
        savedEncounters: string,
        encounterRequired: string,
        noSavedEncounters: string,
    },
    dm_table: {
...
const translations: Record<Locale, TranslationStructure> = {
    en: {
        ...
        dm_actions: {
            ...
            localNamePrompt: "GM name",
            localPassphrasePrompt: "GM passphrase",
            encounterName: "Encounter Name",
            saveEncounter: "Save Encounter",
            loadEncounter: "Load Encounter",
            deleteEncounter: "Delete",
            savedEncounters: "Saved Encounters",
            encounterRequired: "Enter a name to save.",
            noSavedEncounters: "No saved encounters yet.",
        },
        dm_table: {
        ...
        options: {
            ...
            onlineUnavailable: "Configure Firebase or a SQLite sync server to enable online mode.",
            firebase: "Firebase",
            sqlite: "SQLite",
            useTempHP: "Use Temporary HP",
            colorBlindMode: "Colorblind-friendly condition colors",
    ...
    pt_BR: {
        ...
        dm_actions: {
            ...
            localNamePrompt: "Nome do GM",
            localPassphrasePrompt: "Frase secreta do GM",
            encounterName: "Nome do Encontro",
            saveEncounter: "Salvar Encontro",
            loadEncounter: "Carregar Encontro",
            deleteEncounter: "Excluir",
            savedEncounters: "Encontros Salvos",
            encounterRequired: "Digite um nome para salvar.",
            noSavedEncounters: "Nenhum encontro salvo ainda.",
        },
        dm_table: {
        ...
        options: {
            ...
            onlineProvider: "Provedor Online",
            onlineUnavailable: "Configure o Firebase ou um servidor SQLite para habilitar o modo online.",
            firebase: "Firebase",
            sqlite: "SQLite",
            useTempHP: "Usar PV Temporário",
            colorBlindMode: "Cores de condições para daltonismo",
